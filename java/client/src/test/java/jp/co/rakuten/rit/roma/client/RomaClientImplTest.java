...
public class RomaClientImplTest extends TestCase {
  ...
  public void testGetsAndCas01() throws Exception {
    try {
      ...
      assertEquals(CasResponse.OK, CLIENT.cas(KEY + "01", values
          .get(KEY + "01").getCas(), "001".getBytes()));
      assertEquals(CasResponse.NOT_FOUND, CLIENT.cas(KEY + "04", values.get(
          KEY + "01").getCas(), "001".getBytes()));
      assertEquals(CasResponse.EXISTS, CLIENT.cas(KEY + "01", values.get(
          KEY + "01").getCas(), "0001".getBytes()));
    } finally {
      CLIENT.delete(KEY + "01");
      CLIENT.delete(KEY + "02");
      CLIENT.delete(KEY + "03");
  ...
  public void testHashName() throws Exception {
    ...
    try {
      ...
      assertEquals(CasResponse.OK, CLIENT.cas(KEY + "01", values3.get(
          KEY + "01").getCas(), "001".getBytes()));
      assertEquals(CasResponse.OK, another.cas(KEY + "01", values4.get(
          KEY + "01").getCas(), "002".getBytes()));
