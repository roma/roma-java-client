...
public class ListWrapper2Test extends TestCase {
	...
	assertEquals("03", new String(((ListWrapper.Entry) list.get(2))
		.getValue()));
	assertEquals("04", new String(((ListWrapper.Entry) list.get(3))
		.getValue()));
    }
	...
	assertEquals("02", new String(((ListWrapper.Entry) list.get(0))
		.getValue()));
	assertEquals("03", new String(((ListWrapper.Entry) list.get(1))
		.getValue()));
    }
	...
	assertEquals(2, list.size());
	assertEquals("03", new String(((ListWrapper.Entry) list.get(0))
		.getValue()));
	assertEquals("04", new String(((ListWrapper.Entry) list.get(1))
		.getValue()));
    }
