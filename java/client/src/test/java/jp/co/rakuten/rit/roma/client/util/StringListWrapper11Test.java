...
public class StringListWrapper11Test extends TestCase {
  ...
  private static String KEY_PREFIX = StringListWrapper11Test.class.getName();
  ...
  public StringListWrapper11Test() {
    super();
  }
  ...
  public void testAppend02() throws Exception {
    ...
    LISTUTIL = new StringListWrapper(CLIENT, false, 3);
    assertTrue(LISTUTIL.append(KEY, "01"));
    assertTrue(LISTUTIL.append(KEY, "02"));
    assertTrue(LISTUTIL.append(KEY, "03"));
  ...
  public void testAppend03() throws Exception {
    ...
    try {
      LISTUTIL = new StringListWrapper(CLIENT, false, -1);
      fail();
    } catch (Exception e) {
  ...
  public void testDeleteAndAppend10() throws Exception {
    int size = 3;
    long expiry = 1;
    LISTUTIL = new StringListWrapper(CLIENT, false, size, expiry);
