...
public class PerfTestPutAndGet {
  ...
  private void doLoop() throws Exception {
    ...
    StringBuilder sb = new StringBuilder();
    sb.append("qps: ").append((int) (((double) (LOOP_COUNT * 1000)) / time0))
        .append(" ").append("(timeout count: ").append(count_threshold).append(
            ", ").append(count_threshold1).append(")").append(" max = ")
        .append(count_max / 1000).append(", min = ").append(count_min / 1000);
