...
public interface RomaClient {
   ...
   */
  @Deprecated
  boolean append(String key, byte[] value, Date expiry) throws ClientException;
   ...
   * @throws ClientException
   */
  boolean append(String key, byte[] value, long expiry) throws ClientException;
   ...
   */
  @Deprecated
  boolean prepend(String key, byte[] value, Date expiry) throws ClientException;
   ...
   * @throws ClientException
   */
  boolean prepend(String key, byte[] value, long expiry) throws ClientException;
